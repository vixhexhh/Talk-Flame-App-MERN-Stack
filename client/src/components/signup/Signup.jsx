...
const Signup = () => {
  ...
  const handleSubmit = () => {
    ...
    if (!usernameTest) {
      ToastNotifyError('Enter a valid username!');
    }
    if (!emailTest) {
      ToastNotifyError('Enter a valid email address!');
    }
    if (password.trim() === '') {
      ToastNotifyError('Enter a valid password!');
    }
    if (password !== passwordConfirm) {
      ToastNotifyError('Please enter the same password!');
    }
    ...
    <div className='container'>
      ...
      <div className='right-side'>
        <div className='head-section'>
          ...
          <h3 className='cust'>Create an account</h3>
          <p className='text'> </p>
        </div>
